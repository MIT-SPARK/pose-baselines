...
def main(cfg):
    ...
    idx = data['idx']
    cl_ = data['class']
    R_gt2 = train_loader.dataset[10]['R_gt']
    # breakpoint()
    # print("shape of xyz: ", xyz.shape)
    # print("dtype of xyz: ", xyz.dtype)
    # print("shape of points: ", points.shape)
    # print("dtype of points: ", points.dtype)
    # breakpoint()
    # xyz = xyz.T
    # points = R_gt @ points.T
    # xyz_ = xyz - torch.mean(xyz, 1).unsqueeze(-1)
    # points_ = points - torch.mean(points, 1).unsqueeze(-1)
    # display_two_pcs(xyz_.unsqueeze(0), points_.unsqueeze(0))
    ...
    if cfg.eval:
        ...
        for iteration in range(num_iteration):
            ...
            for num, data in enumerate(test_loader):
                ...
                tr_agent.eval_func(data)    # <- this function computes things!
                #TODO: note: tr_agent.pred_t gives you the transform.
